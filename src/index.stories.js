...
import AdvancedLeafletDemo from './demo/advanced/leaflet';
import AdvancedMapboxDemo from './demo/advanced/mapbox';
import AdvancedGoogleMapDemo from './demo/advanced/google-map';
...
const config = {
  ...
  accessToken:
    'pk.eyJ1IjoiaHVuZzE5OTZoeSIsImEiOiJjazcxa2djbngwNnNqM21ubXV1bDhyaXM1In0.G8lSCFr-AIHLyakEjSy9Mg'
};
...
export const Mapbox = () => (
  <Maps isEnableMapbox={true} places={places} config={config} />
);
export const Leaflet = () => (
  <Maps isEnableLeaflet={true} places={places} config={config} />
);
...
export const AdvancedLeaflet = () => (
  <AdvancedLeafletDemo places={places} config={config} />
);
export const AdvancedMapbox = () => (
  <AdvancedMapboxDemo places={places} config={config} />
);
export const AdvancedGoogleMap = () => (
  <AdvancedGoogleMapDemo places={places} config={config} />
);
